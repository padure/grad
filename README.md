...
| # Nr  |                                                                        Teme                                                                         |
| ----- | :-------------------------------------------------------------------------------------------------------------------------------------------------: |
| 01    |                                       [Capitol I. Limbaj de scriptare pentru web](./readMe.md)                                                      |
| 02    |                              [Capitol II. Instrucțiunile limbajului de scriptare](./02_Day_Data_types/02_day_data_types.md)                         |
| 03    |                             [Capitol III. Funcții de scriptare](./03_Day_Booleans_operators_date/03_booleans_operators_date.md)                     |
| 04    |                             [Capitol IV. Obiecte de scriptare](./04_Day_Conditionals/04_day_conditionals.md)                                        |
| 05    |                             [Capitol V. Modelul de obiecte ale documentului (DOM)](./05_Day_Arrays/05_day_arrays.md)                                |
| 06    |                                             [Capitol VI. Evenimente](./06_Day_Loops/06_day_loops.md)                                                |
| 07    |                           [Capitol VII. Modelul de obiecte ale browser-ului (BOM)](./07_Day_Functions/07_day_functions.md)                          |
| 08    |                   [Capitol VIII. Propuneri de proiecte finale pentru rezolvare](./08_Day_Objects/08_day_objects.md)                                 |
